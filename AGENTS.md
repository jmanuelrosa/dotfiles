...
- **Commits and branch names follow the global conventions**, defined in the global instructions ([roles/ai/files/harness/AGENTS.md](roles/ai/files/harness/AGENTS.md)) and the commit skill, not per-repo.
