...
|---|---|---|---|---|
| once | `/product-team:setup-strategy` | interview (optionally seeded by `/idea-refine`) | `docs/strategy/strategy.md`, `docs/strategy/okrs.md`, repo scaffold | strategy PR |
| 0 | `/product-team:0-refine-idea "<idea>"` | interview + strategy | `00-brief.md`, STATUS.md, branch | Gate 0: kill or proceed |
| 1 | `/product-team:1-research` | brief | `01-research/` (3 parallel researchers + summary) | none (feeds Gate 1) |
| 2 | `/product-team:2-write-prd` | brief + research | `02-prd.md` | Gate 1: PM + team |
| 3 | `/product-team:3-red-team` | PRD only (fresh eyes) | `03-red-team-report.md`, PRD revision | none (feeds Gate 1) |
| 4 | `/product-team:4-tech-shape` | PRD + this codebase | `04-design-doc.md`, `docs/adr/` | Gate 2: tech lead |
| 5 | `/product-team:5-decompose` | PRD + design doc | `05-backlog/` epics + stories + ACs | none (feeds Gate 3) |
| 6 | `/product-team:6-gate-check` | backlog | `06-dor-report.md` (PASS/FAIL per story) | Gate 3: final |
| 7 | `/product-team:7-push-to-board` | backlog + DoR report | GitHub issues + Project items, docs/LEARNINGS.md entry | dry-run confirm |
