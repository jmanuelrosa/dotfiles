...
The local footer currently treats usage as unknown only after compaction (`roles/ai/files/harness/adapters/pi/extensions/statusline/index.ts`).
...
Create `roles/ai/files/harness/adapters/pi/extensions/context-continuity/index.ts`.
...
Modify `roles/ai/files/harness/adapters/pi/extensions/statusline/index.ts` so `contextSegment()` checks whether usage belongs to the current model epoch before rendering a percentage.
...
- `roles/ai/files/harness/adapters/pi/extensions/context-continuity/index.ts`
- `lib/python/tests/test_pi_context_continuity.py`

### Local files to modify

- `roles/ai/files/harness/adapters/pi/extensions/statusline/index.ts`
...
- `roles/ai/files/harness/adapters/pi/models.json`
